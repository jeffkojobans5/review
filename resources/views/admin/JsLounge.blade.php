...
<div class="col-lg-12 ">
    <h1 class="dash-title"> Js Lounge <span class="badge badge-pill badge-warning"> {{ count($allReviews) }} </span> </h1>
...
<tbody>
    ...
    <tr>
        ...
        <td> {{ $allReviews[$JsLounge]->ratings }} </td> 
        <td> {{ $allReviews[$JsLounge]->comments ? $JsLounge->comments : 'N/A' }} </td> 
    </tr>
    @endforeach
</tbody>
</table>
