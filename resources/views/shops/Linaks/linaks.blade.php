...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <header>
            <div class="container">
                <div class="logo">
                    <img src=" {{ asset('img/LinaksCollectionLogo.jpeg') }} " alt="logo" >                
                ...
                <div class="buttons">
                        <form action=" {{ route('thank__you') }} " method="post" class="form">
                            @csrf
                            <input type="hidden" id="ratings" name="ratings" value="">                    
                            <input type="hidden" id="ratings" name="branch" value="Linaks">  
